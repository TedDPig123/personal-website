...
export default function GalleryComponents1({position, text, date, place, phoneTop, deskTop}: ExperienceProp) {
    return (
        <>
            <div className="gallery-desktop-1">
                <div className='max-w-[400px] flex-col ml-10 mr-10' style={{ marginTop: `${deskTop * 0.25}rem` }}>
                    <div className='font-telegrafbold text-[16px] mt-12'>{position}</div>
                    ...
                    <div className='flex justify-center'>
                        <div 
                            className="font-telegraf text-[12px] text-center w-50" 
                        >
                            {place}
                        </div>
                    </div>
            ...
            <div className='gallery-phone-1 mx-1 w-[340px] hidden flex-col items-center justify-center h-[150vw]'>
                ...
                <div className='flex justify-center' style={{ marginBottom: `${phoneTop * 0.25}rem` }}>
                    <div 
                        className="font-telegraf text-[12px] text-center w-50"                     >
                        {place}
                    </div>
